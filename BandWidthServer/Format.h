...
const char result_t_receive[] =   "%s [T-Receive] %4.1lf-%4.1lf sec  %ss  %ss/sec\n";
const char result_t_send[] = "%s [T-Send] %4.1lf-%4.1lf sec  %ss  %ss/sec\n";
const char result_n_receive[] =   "%s [N-Receive] %4.1lf-%4.1lf sec  %ss  %ss/sec\n";
const char result_n_send[] = "%s [N-Send] %4.1lf-%4.1lf sec  %ss  %ss/sec\n";
